...
public class EmailClient {
	...
	// INSTANCE DATA \\
	private String to;
	private final String FROM = "matthewmanzi@garnetvalley.org";		// LOCAL TEST INFO
	private final String USERNAME = "matthewmanzi@garnetvalley.org";	// LOCAL TEST INFO
	private final String PASSWORD = "xxxx";								// LOCAL TEST INFO
